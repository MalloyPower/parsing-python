// Generated (bisonified) from 3.1.txt on 2016-11-23 at 16:45:48 +0000
...
typedargslist // Used in: parameters
	...
	| tfpdef opt_EQUAL_test star_COMMA_tfpdef opt_COMMA
	;
opt_EQUAL_test // Used in: typedargslist, star_tfpdef_COMMA, star_COMMA_tfpdef, varargslist, star_vfpdef_COMMA, star_COMMA_vfpdef
	: EQUAL test
	| %empty
	;
...
opt_COMMA // Used in: typedargslist, varargslist, testlist_comp, pick_for_test_test, pick_for_test, pick_argument
	...
	| %empty
	;
tfpdef // Used in: typedargslist, star_tfpdef_COMMA, opt_tfpdef, star_COMMA_tfpdef, opt_DOUBLESTAR_tfpdef, pick_STAR_DOUBLESTAR_tfpdef
	: NAME COLON test
	| NAME
	;
varargslist // Used in: lambdef, lambdef_nocond
	: star_vfpdef_COMMA pick_STAR_DOUBLESTAR_vfpdef
	| vfpdef opt_EQUAL_test star_COMMA_vfpdef opt_COMMA
	;
...
pick_STAR_DOUBLESTAR_vfpdef // Used in: varargslist
	...
	| DOUBLESTAR vfpdef
	;
vfpdef // Used in: varargslist, star_vfpdef_COMMA, opt_vfpdef, star_COMMA_vfpdef, opt_DOUBLESTAR_vfpdef, pick_STAR_DOUBLESTAR_vfpdef
	: NAME
	;
...
plus_stmt // Used in: suite, plus_stmt
	...
	| stmt
	;
test // Used in: funcdef, opt_EQUAL_test, tfpdef, raise_stmt, opt_FROM_test, assert_stmt, if_stmt, star_ELIF, while_stmt, with_item, except_clause, opt_IF_ELSE, lambdef, testlist_comp, star_COMMA_test, subscript, opt_test_only, sliceop, testlist, dictorsetmaker, star_test_COLON_test, opt_DOUBLESTAR_test, pick_argument, argument, testlist1
	: or_test opt_IF_ELSE
	| lambdef
	;
...
star_expr // Used in: comparison, exprlist, star_COMMA_star_expr
	...
	| expr
	;
expr // Used in: with_item, star_expr, expr
	: xor_expr
	| expr BAR xor_expr
	;
...
star_COMMA_star_expr // Used in: exprlist, star_COMMA_star_expr
	...
	| %empty
	;
testlist // Used in: eval_input, expr_stmt, pick_yield_expr_testlist, return_stmt, for_stmt, yield_expr
...
comp_if // Used in: comp_iter
	...
	| IF test_nocond
	;
testlist1 // Used in: start, testlist1
	: test
