// Generated (bisonified) from 1.6.txt on 2016-11-23 at 16:45:42 +0000
...
star_COMMA_fpdef // Used in: varargslist, star_COMMA_fpdef
	...
	| %empty
	;
opt_COMMA // Used in: varargslist, pick_argument_short
	: COMMA
	| %empty
	;
...
plus_stmt // Used in: suite, plus_stmt
	...
	| stmt
	;
test // Used in: opt_EQUAL_test, print_stmt, star_test_COMMA, raise_stmt, opt_COMMA_test, opt_test_3, exec_stmt, assert_stmt, if_stmt, star_ELIF, while_stmt, except_clause, lambdef, subscript, opt_test_only, sliceop, testlist, star_COMMA_test, dictmaker, star_test_COLON_test, opt_DOUBLESTAR_test, pick_argument_short, argument
