// Generated (bisonified) from 2.5.txt on 2016-11-23 at 16:45:45 +0000
...
star_COMMA_fpdef // Used in: varargslist, star_COMMA_fpdef
	...
	| %empty
	;
opt_COMMA // Used in: varargslist, opt_test, opt_test_2, testlist_safe, listmaker, testlist_gexp, pick_argument_short
	: COMMA
	| %empty
	;
...
import_as_name // Used in: import_as_names, star_COMMA_import_as_name
	: NAME opt_NAME
	;
pick_AS_NAME // Used in: opt_NAME
	: AS
	| NAME
	;
opt_NAME // Used in: import_as_name, dotted_as_name
	: pick_AS_NAME NAME
	| %empty
	;
dotted_as_name // Used in: dotted_as_names
	: dotted_name opt_NAME
	;
...
plus_COMMA_old_test // Used in: testlist_safe, plus_COMMA_old_test
	...
	| COMMA old_test
	;
old_test // Used in: testlist_safe, plus_COMMA_old_test, old_lambdef, list_if, gen_if
	: or_test
	| old_lambdef
	;
old_lambdef // Used in: old_test
	...
	;
test // Used in: opt_EQUAL_test, print_stmt, star_COMMA_test, opt_test, plus_COMMA_test, raise_stmt, opt_COMMA_test, opt_test_3, exec_stmt, assert_stmt, if_stmt, star_ELIF, while_stmt, with_stmt, except_clause, opt_IF_ELSE, listmaker, testlist_gexp, lambdef, subscript, opt_test_only, sliceop, testlist, dictmaker, star_test_COLON_test, opt_DOUBLESTAR_test, pick_argument_short, argument, testlist1
	: or_test opt_IF_ELSE
	| lambdef
	;
opt_IF_ELSE // Used in: test
	...
	| %empty
	;
or_test // Used in: old_test, test, opt_IF_ELSE, or_test, gen_for
	: and_test
	| or_test OR and_test
	;
...
comp_op // Used in: comparison
	...
	| IS NOT
	;
expr // Used in: exec_stmt, with_var, comparison, expr, exprlist, star_COMMA_expr
	: xor_expr
	| expr BAR xor_expr
	;
...
atom // Used in: power
	...
	| plus_STRING
	;
pick_yield_expr_testlist_gexp // Used in: opt_yield_test_gexp
	: yield_expr
	| testlist_gexp
	;
opt_yield_test_gexp // Used in: atom
	: pick_yield_expr_testlist_gexp
	| %empty
	;
...
listmaker // Used in: opt_listmaker
	...
	| test star_COMMA_test opt_COMMA
	;
testlist_gexp // Used in: pick_yield_expr_testlist_gexp
	: test gen_for
	| test star_COMMA_test opt_COMMA
	;
...
encoding_decl // Used in: start
	: NAME
	;
yield_expr // Used in: pick_yield_expr_testlist, yield_stmt, pick_yield_expr_testlist_gexp
	: YIELD testlist
	| YIELD
	;
