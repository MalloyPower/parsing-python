// Generated (bisonified) from 3.6.0.txt on 2016-11-23 at 16:45:51 +0000
...
typedargslist // Used in: parameters
	...
	| STAR opt_tfpdef star_COMMA_tfpdef opt_COMMA_DOUBLESTAR_tfpdef
	| DOUBLESTAR tfpdef opt_COMMA
	;
...
opt_tfpdef // Used in: typedargslist, pick_STAR_DOUBLESTAR_tfpdef
	...
	| %empty
	;
opt_COMMA // Used in: typedargslist, opt_DOUBLESTAR_tfpdef, pick_STAR_DOUBLESTAR_tfpdef, varargslist, opt_DOUBLESTAR_vfpdef, pick_STAR_DOUBLESTAR_vfpdef, testlist_star_expr, pick_comp_for, exprlist, pick_for_DOUBLESTAR
	: COMMA
	| %empty
	;
opt_DOUBLESTAR_tfpdef // Used in: opt_COMMA_DOUBLESTAR_tfpdef
	: DOUBLESTAR tfpdef opt_COMMA
	| %empty
	;
opt_COMMA_DOUBLESTAR_tfpdef // Used in: typedargslist, pick_STAR_DOUBLESTAR_tfpdef
	: COMMA opt_DOUBLESTAR_tfpdef
	| %empty
	;
...
varargslist // Used in: lambdef, lambdef_nocond
	...
	| STAR opt_vfpdef star_COMMA_vfpdef opt_COMMA_DOUBLESTAR_vfpdef
...
opt_vfpdef // Used in: varargslist, pick_STAR_DOUBLESTAR_vfpdef
	...
	| %empty
	;
opt_DOUBLESTAR_vfpdef // Used in: opt_COMMA_DOUBLESTAR_vfpdef
	: DOUBLESTAR vfpdef opt_COMMA
	| %empty
	;
opt_COMMA_DOUBLESTAR_vfpdef // Used in: varargslist, pick_STAR_DOUBLESTAR_vfpdef
	: COMMA opt_DOUBLESTAR_vfpdef
	| %empty
	;
...
expr_stmt // Used in: small_stmt
	: testlist_star_expr pick_annassign_augassign
	;
pick_yield_expr_testlist // Used in: pick_annassign_augassign
	: yield_expr
	| testlist
	;
pick_yield_expr_testlist_star_expr // Used in: star_EQUAL
	...
	| testlist_star_expr
	;
star_EQUAL // Used in: star_EQUAL, pick_annassign_augassign
	: star_EQUAL EQUAL pick_yield_expr_testlist_star_expr
	| %empty
	;
pick_annassign_augassign // Used in: expr_stmt
	: annassign
	| augassign pick_yield_expr_testlist
	| star_EQUAL
	;
annassign // Used in: pick_annassign_augassign
...
star_COMMA // Used in: testlist_star_expr, star_COMMA, pick_comp_for
	...
	| %empty
	;
augassign // Used in: pick_annassign_augassign
	: PLUSEQUAL
	| MINEQUAL
	| STAREQUAL
	| ATEQ
...
plus_stmt // Used in: suite, plus_stmt
	...
	| stmt
	;
test // Used in: funcdef, opt_EQUAL_test, tfpdef, annassign, pick_test_star_expr, raise_stmt, opt_FROM_test, assert_stmt, if_stmt, star_ELIF, while_stmt, with_item, except_clause, opt_IF_ELSE, lambdef, subscript, opt_test_only, sliceop, testlist, star_COMMA_test, pick_test_DOUBLESTAR, argument, yield_arg
	: or_test opt_IF_ELSE
	| lambdef
	;
...
opt_comp_for // Used in: argument
	...
	| %empty
	;
comp_iter // Used in: opt_comp_iter, comp_if
	: comp_for
	| comp_if
	;
comp_for // Used in: pick_comp_for, pick_for_DOUBLESTAR, opt_comp_for, comp_iter
	...
	;
opt_ASYNC // Used in: comp_for
	: ASYNC
	| %empty
	;
opt_comp_iter // Used in: comp_for
	: comp_iter
	| %empty
	;
