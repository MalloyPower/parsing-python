// Generated (bisonified) from 1.0.1.txt on 2016-11-23 at 16:45:39 +0000
...
varargslist // Used in: parameters, lambdef
	...
	| fpdef star_fpdef_notest opt_COMMA
	;
star_fpdef_COMMA // Used in: varargslist, star_fpdef_COMMA
	: star_fpdef_COMMA fpdef COMMA
	| %empty
	;
star_fpdef_notest // Used in: varargslist, star_fpdef_notest, fplist
...
opt_COMMA // Used in: varargslist
	...
	| %empty
	;
fpdef // Used in: varargslist, star_fpdef_COMMA, star_fpdef_notest, fplist
	: NAME
	| LPAR fplist RPAR
	;
...
expr_stmt // Used in: small_stmt
	: star_testlist_EQUAL testlist
	;
star_testlist_EQUAL // Used in: expr_stmt, star_testlist_EQUAL
	: star_testlist_EQUAL testlist EQUAL
	| %empty
	;
...
import_stmt // Used in: small_stmt
	: IMPORT NAME star_COMMA_NAME
	| FROM NAME IMPORT pick_STAR_NAME
	;
star_COMMA_NAME // Used in: import_stmt, star_COMMA_NAME, pick_STAR_NAME, global_stmt, access_stmt
...
except_clause // Used in: plus_except
	...
	| EXCEPT
	;
suite // Used in: funcdef, if_stmt, star_ELIF, while_stmt, for_stmt, try_stmt, plus_except, classdef
	: simple_stmt
...
plus_stmt // Used in: suite, plus_stmt
	...
	| stmt
	;
test // Used in: print_stmt, star_test_COMMA, raise_stmt, exec_stmt, opt_COMMA_test, if_stmt, star_ELIF, while_stmt, except_clause, lambdef, subscript, opt_test_only, testlist, star_COMMA_test, dictmaker, star_test_COLON_test
...
star_COMMA_expr // Used in: exprlist, star_COMMA_expr
	...
	| %empty
	;
testlist // Used in: eval_input, expr_stmt, star_testlist_EQUAL, return_stmt, for_stmt, atom, opt_testlist, classdef
