// Generated (bisonified) from 2.6.txt on 2016-11-23 at 16:45:46 +0000
...
star_COMMA_fpdef // Used in: varargslist, star_COMMA_fpdef
	...
	| %empty
	;
opt_COMMA // Used in: varargslist, opt_test, opt_test_2, testlist_safe, listmaker, testlist_gexp, pick_argument
	: COMMA
	| %empty
	;
...
old_lambdef // Used in: old_test
	...
	;
test // Used in: opt_EQUAL_test, print_stmt, star_COMMA_test, opt_test, plus_COMMA_test, raise_stmt, opt_COMMA_test, opt_test_3, exec_stmt, assert_stmt, if_stmt, star_ELIF, while_stmt, with_stmt, opt_AS_COMMA, opt_test_0, opt_IF_ELSE, listmaker, testlist_gexp, lambdef, subscript, opt_test_only, sliceop, testlist, dictmaker, star_test_COLON_test, opt_DOUBLESTAR_test, pick_argument, argument, testlist1
	: or_test opt_IF_ELSE
	| lambdef
	;
